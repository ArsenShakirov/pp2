...
class Coin(pygame.sprite.Sprite):
    ...
    def move(self):
        self.rect.move_ip(0, SPEED + self.weight)  # The speed of the coin is influenced by its weight
...
class Enemy(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        # Increase the speed of Enemy when the player earns 10 coins
        if COINS_COLLECTED >= 10:
            self.rect.move_ip(0, 1)  # Increase speed when threshold is reached
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        ...
        for coin in coins:
            coin.rect.center = (random.randint(40, SCREEN_WIDTH - 40), random.randint(-600, -50))
