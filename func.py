...
print(movies_above_5_5(movies))  # List where IMDB > 5.5
print(movies_by_category(movies, "Romance"))  # List of rom movies
print(average_imdb_score(movies))  # Avg IMDB score of all 
print(average_imdb_score_by_category(movies, "Romance"))  # Avg IMDB score of rom movies
